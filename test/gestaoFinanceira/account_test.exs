defmodule GestaoFinanceira.AccountTest do
  use GestaoFinanceira.DataCase

  alias GestaoFinanceira.Account

  import GestaoFinanceira.AccountFixtures
  alias GestaoFinanceira.Account.{User, UserToken}
